          ...
          <div className="bg-white rounded-lg shadow-lg max-w-md w-full">
            <div className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    {newSupplier.type === 'cj_dropshipping'
                      ? 'CJ openId (secret de signature webhook)'
                  ...
                  <input
                    ...
                    placeholder={
                      newSupplier.type === 'cj_dropshipping'
                        ? 'Enter your CJ openId'
                        : 'Enter your API secret'
                    }
                  />
                  {newSupplier.type === 'cj_dropshipping' && (
                    <p className="mt-1 text-xs text-gray-500">
                      Utilisé uniquement côté serveur pour vérifier la signature HMAC des webhooks CJ.
                    </p>
                  )}
                </div>
