    ...
    'getting-started': [
      {
        ...
        description:
          'Présentation de la plateforme et de ses fonctionnalités principales',
        readTime: '5 min',
      },
      {
        id: 'account-setup',
      ...
      },
      {
        ...
        description:
          'Guide pour connecter Shopify, WooCommerce et autres plateformes',
        readTime: '10 min',
      },
      {
        id: 'first-import',
        ...
        description:
          'Comment importer vos premiers produits depuis différentes sources',
        readTime: '12 min',
      },
    ],
    guides: [
...
async function importProduct(url) {
  ...
  const filteredArticles = Object.entries(articles).reduce(
    (acc, [category, items]) => {
    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Guides complets, tutoriels et références techniques pour tirer le
          meilleur parti de Shopopti+
        </p>
      </div>
          ...
          {searchQuery ? (
              ...
              {Object.keys(filteredArticles).length > 0 ? (
                ...
                <div className="text-center py-12 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-gray-500 mb-6">
                    Nous n'avons pas trouvé d'article correspondant à votre
                    recherche.
                  </p>
            ...
            <div>
              <div className="mb-6 flex items-center text-sm text-gray-500">
                <Link to="/documentation" className="hover:text-gray-700">
                  Documentation
                </Link>
              ...
              <h1 className="text-3xl font-bold mb-6">
                {articleContent['introduction'].title}
              </h1>
              ...
              <div className="prose prose-lg max-w-none">
                {articleContent['introduction'].sections.map(
                  (section, index) => (
                  ...
                  <div className="bg-gray-900 rounded-lg p-4 mb-8">
                    <div className="flex justify-between items-center mb-2">
                      <h3 className="text-white font-medium">
                        {articleContent['introduction'].code.title}
                      </h3>
                      <button
                        onClick={() =>
                          copyToClipboard(
                            articleContent['introduction'].code.content,
                            'code-example',
                          )
                        }
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {articles[activeCategory as keyof typeof articles]?.map(
                  (article) => (
                    <Link
                      key={article.id}
