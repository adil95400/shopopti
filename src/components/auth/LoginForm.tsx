...
const getErrorMessage = (error: unknown) =>
  error instanceof Error && error.message ? error.message : 'Identifiants incorrects';
...
const LoginForm: React.FC<LoginFormProps> = ({ onClose, isModal = false }) => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // ProtectedRoute is the single fail-closed MFA gate. It checks the
      // session AAL and requests a second factor when aal1 -> aal2.
